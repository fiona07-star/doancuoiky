...
from PyQt6.QtWidgets import QListWidgetItem, QTableWidgetItem, QMessageBox, QApplication, QHeaderView
...
class MainWindowKhachExt(Ui_MainWindow_khach_xem_diem):
    ...
    def lien_he_tu_van(self):
        """Mở trang web liên hệ tư vấn"""
        webbrowser.open("https://tuyensinh.uel.edu.vn/faq/")
